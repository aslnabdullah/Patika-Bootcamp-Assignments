...
import Week7.PatikaClone.comPatikaDev.Helper.*;
...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator){
        ...
        //ModelUserList Finish --------------------------------------


        //Patika List Model Start -----------------------------------------
    ...
    public JComboBox getCmb_user_type() {
        return cmb_user_type;
    }

    public void setCmb_user_type(JComboBox cmb_user_type) {
        this.cmb_user_type = cmb_user_type;
    }
}
